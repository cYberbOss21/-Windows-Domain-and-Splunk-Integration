...
4.	Name the OU (e.g., IT, HR, Admins).
...
3.	Fill in user details (e.g., Bob, username bob).
4.	Set a password and configure options such as "User must change password at next logon," or the preference you prefer.
...
4.	Access Splunk Web at http://kali:8000.
...
3.	Run the installer and choose "On-premises Splunk Enterprise instance."
4.	Set the deployment server to 192.168.10.4:9997 (Splunk Enterprise server IP).
...
4.	Run the following search to see logs:
   **index=windows_audit**
